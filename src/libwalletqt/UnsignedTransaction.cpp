...
quint64 UnsignedTransaction::amount(unsigned int index) const
{
...
quint64 UnsignedTransaction::fee(unsigned int index) const
{
...
quint64 UnsignedTransaction::mixin(unsigned int index) const
{
